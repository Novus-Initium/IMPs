      ...
      <div className="flex items-center flex-col flex-grow pt-2 bg-secondary">
        <div className="px-5">
          <h1 className="text-center">
            ...
            <span className="block text-3xl font-bold">Admin A Round</span>
          </h1>
        </div>
        <div className="flex-grow bg-base-300 w-full mt-2 px-8 py-6 bg-secondary">
          <div className="flex justify-center items-center gap-6 flex-col sm:flex-row bg-secondary">
