...
const ProjectsPage = () => {
  return (
    <div className="glass min-h-screen bg-base-100 flex flex-col items-center justify-center">
      <Head>
        <title>Projects</title>
      </Head>
      <div className="bg-base-300 shadow-md rounded-lg p-10 max-w-lg w-full text-center">
        <h1 className="text-3xl font-extrabold mb-8 text-neutral">Projects</h1>
        <div>
